    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ backgroundColor: '#0f2040' }}>
      ...
      {status === 'success' && (
        <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', padding: '48px 40px', maxWidth: '480px', width: '100%', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: 'Sora, sans-serif', color: '#0f2040', fontSize: '1.75rem', fontWeight: 700, marginBottom: '12px' }}>
            You're enrolled!
          </h1>
          <p style={{ color: '#64748b', marginBottom: '32px', lineHeight: 1.6 }}>
            Payment confirmed. Your course is ready. Work through all 10 chapters, then take the final exam to earn your certificate.
          </p>
          <Link
            href="/course"
            style={{ display: 'block', backgroundColor: '#f59e0b', color: '#0f2040', fontWeight: 700, padding: '14px', borderRadius: '10px', fontSize: '1rem', textDecoration: 'none' }}
          >
            Start Chapter 1 →
          </Link>
        </div>
      ...
      {status === 'error' && (
        <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', padding: '40px', maxWidth: '440px', width: '100%', textAlign: 'center' }}>
          <h1 style={{ fontFamily: 'Sora, sans-serif', color: '#dc2626', fontSize: '1.5rem', fontWeight: 700, marginBottom: '12px' }}>
            Something went wrong
          </h1>
          <p style={{ color: '#64748b', marginBottom: '24px' }}>
            Your payment may have been processed. Please contact us at support@clearpassdrive.com.
          </p>
